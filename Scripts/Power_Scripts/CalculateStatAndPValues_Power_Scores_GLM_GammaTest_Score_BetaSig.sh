...
module load R/4.0
Rscript MainPipeline_Power_Scores_GLM_GammaTest_Score_BetaSig.R $CHR $SS $SEED $GENE $YPREV $ORSizeGene $percentageAssocGene $LowLDGeneTF $FitScore $startVal $stopVal $ORSizeSNP $percentageAssocSNP $LowLDSNPTF $covs $Cat --nosave
