...
############################################################
RunPowerPipelineDesparseLasso_GammaTest_Score_BetaZero(chr = chr, gene = gene, numPairs = numPairs, YPrev = YPrev, covs = covs, FitScore = FitScore, Cat=Cat, ORSize = ORSize, start = startVal, stop = stopVal, percentageAssoc = percentageAssoc, LowLD = LowLD)