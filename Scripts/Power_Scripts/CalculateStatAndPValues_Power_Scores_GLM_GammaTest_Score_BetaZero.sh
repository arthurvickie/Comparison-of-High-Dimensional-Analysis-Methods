...
module load R/4.0
Rscript MainPipeline_Power_Scores_GLM_GammaTest_Score_BetaZero.R $CHR $SS $SEED $GENE $YPREV $FitScore $covs $Cat $startVal $stopVal $ORSize $percentageAssoc $lowLDTF --nosave 
