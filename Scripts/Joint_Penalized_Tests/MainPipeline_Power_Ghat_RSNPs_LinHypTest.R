...
RunPowerPipelineLinHypTestCat_RSNP(chr = chr, gene = gene, numPairs = numPairs, YPrev = YPrev, Gamma = gammaEff, TrueScore = score, ORSize = ORSize, standardizeScores = FALSE, weightedScores = FALSE, start = startVal, stop = stopVal, percentageAssoc = percentageAssoc, LowLD = LowLD)
