...
RunPowerPipelineLinHypTestCont_RSNP(chr = chr, gene = gene, numPairs = numPairs, Gamma = gammaEff, TrueScore = score, ORSize = ORSize, standardizeScores = FALSE, weightedScores = FALSE, start = startVal, stop = stopVal, percentageAssoc = percentageAssoc, LowLD = LowLD)
