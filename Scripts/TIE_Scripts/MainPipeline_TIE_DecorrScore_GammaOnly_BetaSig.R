...
RunTIEPipelineDecorrScore_GammaTest_BetaSig(chr = chr, gene = gene, numPairs = numPairs, YPrev = YPrev, ORSize = ORSize, percentageAssoc = percentageAssoc, LowLD = LowLD, covs = covs, FitScore = FitScore, Cat = Cat, start = start, stop = stop)
